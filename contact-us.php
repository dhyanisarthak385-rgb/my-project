                                        ...
                                        <div class="container">
                                            <div class="mega-menu__widget">
                                                <ul class="sub-menu--image">
                                                    <li> <a href="index.html"><img src="img/promotion/1.jpg" alt="alt"></a>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
                                    <input class="form-control ps-form__input" type="text" placeholder="Name and Surname" name="full_name">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
