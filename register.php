          ...
          <div class="col-6 col-md-6">
            <form action="controllers/users.php" method="post">
              <div class="ps-form--review">
                <h2 class="ps-form__title">Registeration form</h2>
                <div class="ps-form__group">
                  <label class="ps-form__label">username *</label>
                  <input class="form-control ps-form__input" type="name"  name="username"/>
                </div>
                 <div class="ps-form__group">
                 ...
                 <div class="ps-form__group">
                  ...
                  <input class="form-control ps-form__input" type="phone" name="phone" />
                </div>
