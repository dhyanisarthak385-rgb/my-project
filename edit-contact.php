...
$id = $_GET['id'];
$sql = "SELECT * FROM contcats WHERE id = '$id'";
            ...
            <div class="container">
                ...
                <form action="controllers/insert.php" method="post">
                    <div class="ps-form--contact">
                        <h2 class="ps-form__title">Edit Contact</h2>
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
                                    <input class="form-control ps-form__input" type="text" placeholder="Name and Surname" value="<?php echo $row['Name']?>" name="full_name">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-form__group">
                        ...
                        <div class="ps-form__submit">
                            <button class="ps-btn ps-btn--warning">update your details</button>
                        </div>
                    </div>
                </form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-8">
                                    <div class="ps-footer--contact">
                                        ...
                                        <hr>
                                        <p><a class="ps-footer__email" href="/cdn-cgi/l/email-protection#8be8e4e5ffeae8ffcbeef3eae6fbe7eea5e8e4e6"> <i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="1a7975746e7b796e5a7f627b776a767f34797577">[email&#160;protected]</span> </a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
