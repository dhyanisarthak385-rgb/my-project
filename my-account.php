    ...
    <div class="ps-page">
        ...
        <<div class="ps-wishlist">
            <div class="container">
                ...
                <h3 class="ps-wishlist__title">contact  details
                <div class="ps-wishlist__content">
                    ...
                    <div class="ps-wishlist__table">
                        <table class="table ps-table ps-table--product">
                            ...
                            <tbody>
                                <tr>
                                    <td class="ps-product__name"> <a href="product1.php"><?php echo $row['id']?><a></td>
                                     <td class="ps-product__name"> <a href="product1.php"><?php echo $row['Name']?><a></td>
                                     <td class="ps-product__name"> <a href="product1.php"><?php echo $row['email']?><a></td>
                                      <td class="ps-product__name"> <a href="product1.php"><?php echo $row['phone']?><a></td>
                                       <td class="ps-product__name"> <a href="product1.php"><?php echo $row['message']?><a></td>                                            
                                    
                                    <td class="ps-product__cart">
                                        <a href="edit-contact.php?id=<?php echo $row['id']?>" class="ps-btn">Edit</a>
                                        <a href="controllers/delete.php?id=<?php echo $row['id']?>"class="ps-btn" > delete</a>
                                    </td>
                                </tr>
                                <tr>
                                    <?php 
